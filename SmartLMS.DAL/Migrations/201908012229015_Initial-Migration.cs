namespace SmartLMS.DAL.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Answer_Id = c.Guid(),
                        Question_Id = c.Guid(),
                        MultipleChoiceQuestion_Id = c.Guid(),
                        ReorderingQuestion_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Answer", t => t.Answer_Id)
                .ForeignKey("dbo.Question", t => t.Question_Id)
                .ForeignKey("dbo.Question", t => t.MultipleChoiceQuestion_Id)
                .ForeignKey("dbo.Question", t => t.ReorderingQuestion_Id)
                .Index(t => t.Answer_Id)
                .Index(t => t.Question_Id)
                .Index(t => t.MultipleChoiceQuestion_Id)
                .Index(t => t.ReorderingQuestion_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.QuestionAnswer", "ReorderingQuestion_Id", "dbo.Question");
            DropForeignKey("dbo.QuestionAnswer", "MultipleChoiceQuestion_Id", "dbo.Question");
            ...
            DropIndex("dbo.QuestionAnswer", new[] { "ReorderingQuestion_Id" });
            DropIndex("dbo.QuestionAnswer", new[] { "MultipleChoiceQuestion_Id" });
