    ...
    var methods = {
        ...
        _select: function($dropdown, $target) {
            ...
            if (!multi) {
                ...
                $select.val($target.attr("value")).trigger("dropdownjs.change");
            ...
            if (this.options.onSelected) {
                this.options.onSelected($dropdown.data("select"), $target.attr("value"));
            }
        },
