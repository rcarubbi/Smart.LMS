    ...
    function TouchSwipe(element, options) {
        ...
        var useTouchEvents = (SUPPORTS_TOUCH || SUPPORTS_POINTER || !options.fallbackToMouseEvents),
            START_EV = useTouchEvents
                ? (SUPPORTS_POINTER ? (SUPPORTS_POINTER_IE10 ? "MSPointerDown" : "pointerdown") : "touchstart")
                : "mousedown",
            MOVE_EV = useTouchEvents
                ? (SUPPORTS_POINTER ? (SUPPORTS_POINTER_IE10 ? "MSPointerMove" : "pointermove") : "touchmove")
                : "mousemove",
            END_EV = useTouchEvents
                ? (SUPPORTS_POINTER ? (SUPPORTS_POINTER_IE10 ? "MSPointerUp" : "pointerup") : "touchend")
                : "mouseup",
            LEAVE_EV =
                useTouchEvents
                    ? (SUPPORTS_POINTER ? "mouseleave" : null)
        ...
        function triggerHandlerForGesture(event, phase, gesture) {
            ...
            if (gesture == SWIPE) {
                ...
                if (options.swipeStatus) {
                    ret = options.swipeStatus.call($element,
                        event,
                        phase,
                        direction || null,
                        distance || 0,
                ...
                if (phase == PHASE_END && validateSwipe()) {
                    ...
                    if (options.swipe) {
                        ret = options.swipe.call($element,
                            event,
                            direction,
                            distance,
                            duration,
                    ...
                    case LEFT:
                        ...
                        if (options.swipeLeft) {
                            ret = options.swipeLeft.call($element,
                                event,
                                direction,
                                distance,
                                duration,
                    ...
                    case RIGHT:
                        ...
                        if (options.swipeRight) {
                            ret = options.swipeRight.call($element,
                                event,
                                direction,
                                distance,
                                duration,
                    ...
                    case UP:
                        ...
                        if (options.swipeUp) {
                            ret = options.swipeUp.call($element,
                                event,
                                direction,
                                distance,
                                duration,
                    ...
                    case DOWN:
                        ...
                        if (options.swipeDown) {
                            ret = options.swipeDown.call($element,
                                event,
                                direction,
                                distance,
                                duration,
            ...
            if (gesture == PINCH) {
                $element.trigger("pinchStatus",
                    [
                        phase, pinchDirection || null, pinchDistance || 0, duration || 0, fingerCount, pinchZoom,
                        fingerData
                    ]);

                if (options.pinchStatus) {
                    ret = options.pinchStatus.call($element,
                        event,
                        phase,
                        pinchDirection || null,
                        pinchDistance || 0,
                ...
                if (phase == PHASE_END && validatePinch()) {
                    ...
                    case IN:
                        $element.trigger("pinchIn",
                            [
                                pinchDirection || null, pinchDistance || 0, duration || 0, fingerCount, pinchZoom,
                                fingerData
                            ]);

                        if (options.pinchIn) {
                            ret = options.pinchIn.call($element,
                                event,
                                pinchDirection || null,
                                pinchDistance || 0,
                                duration || 0,
                    ...
                    case OUT:
                        ...
                        if (options.pinchOut) {
                            ret = options.pinchOut.call($element,
                                event,
                                pinchDirection || null,
                                pinchDistance || 0,
                                duration || 0,
